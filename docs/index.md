...
| --- | --- | --- | --- | --- | --- |
| 001 | [Meeting Copilot](./specs/001-feature-meeting-copilot/spec.md) | feature | `feature/001-meeting-copilot` | tasks | active |
...
- [tasks.md](./specs/001-feature-meeting-copilot/tasks.md) — 56 tarefas em 7 fases
